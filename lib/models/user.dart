...
class AppUser {
  ...
  final String? vote;
  final String? createdAt; // AJOUTER CETTE LIGNE
  ...
  AppUser({
    ...
    this.photoUrl,
    this.vote,
    this.createdAt, // AJOUTER CETTE LIGNE
  });
  ...
  factory AppUser.fromJson(Map<String, dynamic> json) {
    ...
    return AppUser(
      ...
      createdAt: json['created_at']?.toString(), // AJOUTER CETTE LIGNE
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'photo_url': photoUrl,
      'vote': vote,
      'created_at': createdAt, // AJOUTER CETTE LIGNE
    };
  }
